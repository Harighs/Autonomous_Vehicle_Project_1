...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/dataset/data.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train/with_albumentation2/weights/best.pt", help="model path(s)")
